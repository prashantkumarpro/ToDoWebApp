...
export const SideNav = () => {
  ...
  const { isActive } = useContext(toDoesContext)
    ...
    sideNavContainer  w-[220px] h-[calc(100% - 5rem)]overflow-hidden flex items-center flex-col mt-20 gap-2`} >
      <Link to="/" className='w-full text-center text-[#000]  text-xl  flex items-center justify-start '>
        <li className='w-full flex items-center justify-start py-2'>
          ...
          <h1 className={`${isActive ? 'block' : 'hidden'} text-sm`}>Home</h1>
        </li>
      </Link>
      <Link to="/CreateTask" className='w-full text-[#000] text-xl  flex items-center justify-start '>
        <li className='w-full flex items-center justify-start py-2'>
          ...
          <h1 className={`${isActive ? 'block' : 'hidden'} text-sm`}>Add</h1>
        </li>
      </Link>
      <Link to="/allTasks" className='w-full text-center text-[#000]  text-xl  flex items-center justify-start '>
        <li className='w-full flex items-center justify-start py-2'>
          <div className='px-5'>
          ...
          <h1 className={`${isActive ? 'block' : 'hidden'} text-sm`}>All Tasks</h1>
        </li>
      </Link>
    </ul>
  )
