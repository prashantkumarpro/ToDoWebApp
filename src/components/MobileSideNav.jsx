...
const MobileSideNav = () => {
    ...
    return (
        ...
        <Link to="/CreateTask" className='w-full text-[#333] text-xl  flex items-center justify-start '>
        ...
        <Link to="/allTasks" className='w-full text-center text-[#333]  text-xl  flex items-center justify-start '>
            <li className='w-full flex items-center justify-start py-2'>
                <div className='px-5'>
